...
Movable.prototype.walkPath = function(){
    ...
    if(currentTileX == this.pendingPath[this.pathProgress].x && currentTileY == this.pendingPath[this.pathProgress].y){
        this.pathProgress++;
...
Movable.prototype.setPath = function(path){
    ...
    // this.pendingPath = this.game.collisionMap.smoothenPath(this.pendingPath);
